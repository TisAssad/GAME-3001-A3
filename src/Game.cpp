...
void Game::ChangeSceneState(const SceneState new_state, int spawnDoor)
{
	if (new_state != m_currentSceneState) {
		...
		case SceneState::TEMPLATE:
			m_pCurrentScene = new TemplateScene();
			std::cout << "template scene activated" << std::endl;
			break;

		case SceneState::HALLWAY:
			m_pCurrentScene = new HallwayScene(spawnDoor);
			break;

		case SceneState::TUTORIAL:
			m_pCurrentScene = new Tutorial;
